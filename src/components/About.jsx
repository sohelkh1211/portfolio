  ...
  return (
    <>
      ...
      <div className="relative flex top-20 w-full">
        ...
        <div className='absolute flex lg:top-[280%] md:top-[310%] sm:top-[330%] xs:top-[490%] lg:ml-[36%] md:ml-[30%] sm:ml-[25%] xs:ml-[10%] w-fit pb-6 mb-1 border-none border-green-800'>
