    ...
    return (
        <>
            ...
            <div ref={ref2} className="relative flex flex-row flex-wrap top-[235px] lg:w-[50%] md:w-[60%] sm:w-[70%] xs:w-[80%] mx-auto shadow-md bg-gradient-to-br from-[#f9e5de] to-[#fedcfe] rounded-xl overflow-hidden">
                <motion.div initial="hidden" animate="visible" variants={fade("left",isInView2, 0.4)} className='sm:absolute xs:relative flex sm:w-[34%] lg:h-[110px] md:h-[100px] sm:h-[100px] xs-h-[70px] xs:w-[90%] mt-[20px] sm:ml-[3%] xs:mx-auto container1 rounded-xl overflow-hidden border-none border-pink-500 cursor-pointer'>
